  ...
  <body>
    <div class="container">
      ...
      <div class="blog-sidebar col-sm-3 text-left">
        ...
        <form action="<?php echo site_url("Welcome/search_name")?>" method="post">
        ...
        <p style="color:#EE7600; text-align:center">------------------------------------</p>
        <form oninput="level.value = flevel.valueAsNumber" action="<?php echo site_url("Welcome/search_lavel")?>" method="post">
          <p style="font-size:15px; color:white; text-align:center">ค้นหาตามงบประมาณ</p>
            <input name="flevel" id="flying" type="range" min="300" max="2000" value="500">
            <output style="font-size:15px; color:white; text-align:center" for="flying" name="level">500</output></p>
            <div class="col-sm-offset-5">
              <button class="btn" type="submit">ค้นหา</button>
				 		</div>
              <p style="color:#EE7600; text-align:center">-----------------------------------</p>
            </form>
            <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Flocalhost%2FSWE-207%2Fgs_corner%2Findex.php%2FWelcome%2F&layout=box_count&size=large&mobile_iframe=true&width=65&height=58&appId" width="65" height="58" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true">
            </iframe>
      ...
      <div class="col-sm-9 blog-main">
                     ...
                     foreach($all->result_array() as $row3){
                      echo '<div class="col-sm-6 col-md-4">
                              ...
                              <img style="height: 200px!important;" id="0" src="'.base_url().''.$row3["picture_box"].'" alt="'.$row3["nameProduct"].'">
                                <div class="caption">
                                  <a href="'.site_url("Welcome/show_detail?id=".$row3['idProduct']).'" style=" font-size:13px;bold;color: black;">'.$row3["nameProduct"].'</a>
                                  ...
                                  <form id="myform" method="post" action="'.site_url('Welcome/add2cart').'">
       ...
       <!-- /.row -->
       <a href="<?php echo site_url('Welcome/view_product') ?>" class="btn btn-3">
       <div id="cart">
           <section>
